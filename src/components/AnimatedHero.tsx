export default function AnimatedHero() {
  return (
    <div className="relative py-16 px-4">
      <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-[1.2] text-center tracking-tight">
        <div className="block mb-6 pb-2">
        ...
        <div className="block relative pb-8">
          ...
          <svg 
            className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-full max-w-[800px]" 
            height="16" 
            viewBox="0 0 800 16" 
