...
export default function TelegramLoginButton({ onAuth }: TelegramLoginButtonProps) {
  ...
  return (
    <Button
      ...
      disabled={loading}
      className="w-full bg-gradient-to-r from-[#2AABEE] to-[#229ED9] hover:from-[#229ED9] hover:to-[#2AABEE] text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 relative overflow-hidden group"
    >
