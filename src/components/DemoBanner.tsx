...
export default function DemoBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 animate-slide-up flex justify-center px-4">
      <div className="w-full max-w-2xl bg-gradient-to-r from-gray-900/98 via-gray-900/95 to-gray-900/98 backdrop-blur-xl border-2 border-gold-400/30 rounded-2xl shadow-2xl shadow-gold-500/20 p-6">
        <button
