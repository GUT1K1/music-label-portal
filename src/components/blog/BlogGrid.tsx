        ...
        <div className="text-center mb-20 space-y-6">
          <div className="inline-block animate-scaleIn">
            <div className="relative">
              ...
              <h1 className="relative text-6xl md:text-8xl font-black mb-4 bg-gradient-to-r from-yellow-400 via-orange-500 to-amber-500 bg-clip-text text-transparent animate-shimmer bg-[length:200%_100%]">Полезные статьи</h1>
            </div>
          </div>
